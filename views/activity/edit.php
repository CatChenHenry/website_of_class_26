...
<head>
    ...
    <style>
        ...
        .preview-box table { border-collapse: collapse; margin: 8px 0; }
    ...
    <script>
        ...
        function renderPreview() {
            ...
            try {
                ...
                preview.innerHTML = DOMPurify.sanitize(preview.innerHTML.replace(
                    /\$\$([\s\S]*?)\$\$/g,
                    function(match, formula) {
                        var cleanFormula = formula.replace(/<br\s*\/?>/g, '').trim();
