        ...
        <div class="qzone-card">
            ...
            <form method="POST" action="/activity/store" id="activityForm">
                ...
                <div class="qzone-form-item">
                    ...
                    <input type="text" name="name" id="actName" class="qzone-form-input" required maxlength="255" placeholder="请输入活动名称">
                </div>
                <div class="qzone-form-item">
                    <label class="qzone-form-label">活动时间</label>
                    <input type="datetime-local" name="activity_time" id="actTime" class="qzone-form-input" required>
                </div>
                <div class="qzone-form-item">
                    <div class="editor-area">
                        <div class="editor-pane">
                            <label>活动内容（Markdown）</label>
                            <textarea name="content" id="contentEditor" class="editor-textarea" placeholder="支持 Markdown 语法，如：## 标题&#10;**粗体** *斜体*&#10;- 列表项&#10;$$E=mc^2$$"></textarea>
                        </div>
                ...
                <div class="qzone-form-actions">
                    ...
                    <a href="/activity/index" class="qzone-btn qzone-btn-secondary">返回</a>
                </div>
            </form>
        </div>
    </div>
